...
<template>
  ...
  <header class="header wrap">
    <a class="brand" href="#home" aria-label="Chettiyar Kada home"><span class="brand-mark">CK<span>✦</span></span><span>CHETTIYAR KADA<small>PALAKKAD, KERALA</small></span></a>
    <button class="menu-toggle" @click="menuOpen = !menuOpen" :aria-expanded="menuOpen" aria-controls="navigation">Menu ☰</button>
    <nav id="navigation" :class="{ open: menuOpen }" aria-label="Main navigation"><a href="#home" :aria-current="page === 'home' ? 'page' : undefined">Home</a><a href="#shops">Our shops</a><a href="#catalogues" :aria-current="page === 'catalogues' ? 'page' : undefined">Catalogue</a><a href="#about" :aria-current="page === 'about' ? 'page' : undefined">About us</a><a class="nav-visit" href="#contact">Visit us <span>↗</span></a></nav>
  </header>
  <main id="main">
    ...
    <section id="catalogue-section" class="catalogue-section" :class="{ 'full-catalogue': page === 'catalogues' }"><div class="wrap"><div class="section-heading"><div><p class="eyebrow">TAKE A CLOSER LOOK</p><h2>Our <em>catalogue.</em></h2></div><p>More to discover, all in one place.<br>Our shared catalogue is on its way.</p></div><div class="catalogue-list"><div class="catalogue-row"><span class="catalogue-icon">▤</span><span class="catalogue-name"><small>ALL THREE SHOPS</small><h3>Chettiyar Kada Catalogue</h3></span><a v-if="catalogue.url" class="catalogue-link" :href="catalogue.url" target="_blank" rel="noopener noreferrer">View catalogue ↗</a><span v-else class="coming-soon">Coming soon <span>↗</span></span></div></div><p class="catalogue-help">Looking for something specific? <a href="tel:+917012891724">Give us a call →</a></p></div></section>
  ...
  <footer><div class="wrap footer-main"><a class="brand" href="#home"><span class="brand-mark">CK<span>✦</span></span><span>CHETTIYAR KADA<small>THREE SHOPS. ONE FAMILIAR NAME.</small></span></a><div><a href="#shops">Our shops</a><a href="#catalogues">Catalogue</a><a href="#about">About us</a><a href="#contact">Contact</a></div></div><div class="wrap footer-bottom"><span>© {{ new Date().getFullYear() }} Chettiyar Kada. All rights reserved.</span><span>With warmth, from Palakkad. <b>✳</b></span></div></footer>
</template>
